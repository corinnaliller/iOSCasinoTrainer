...
class RouletteBetViewController: UIViewController {
    ...
    //var bet: RouletteBet?
    var guest: Player?
    var controller: SelectRouletteBetController?
...
//        hideSplitButtons()
        //hideOutsideButtons()
        //hideForCorner()
        self.controller = SelectRouletteBetController(view: self)
    }
//    func hideForCorner() {
...
//    }
    @IBAction func selectBetType(_ sender: UISegmentedControl) {
        controller?.selectBetType(sender)
//        selectedNumber = 37
//        splitNumber = 0
//        lMessage.text = ""
...
//        lMessage.text = "\(count) Column"
    ...
    @IBAction func selectDozenBet(_ sender: UIButton) {
        controller?.selectDozenBet(sender)
...
//        lMessage.text = "\(count) Dozen"
    ...
    @IBAction func selectOutsideBet(_ sender: UIButton) {
        controller?.selectOutsideBet(sender)
...
//        lMessage.text = "\(out) Numbers"
    ...
    @IBAction func selectFullNumber(_ sender: UIButton) {
        controller?.selectFullNumber(sender)
...
//        }
    ...
    @IBAction func placeRouletteBet(_ sender: UIButton) {
        if controller!.placeRouletteBet() {
